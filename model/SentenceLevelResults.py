...
class SentenceLevelResults:
    ...
    def create_sentence_level_df(self, text_characteristics, easy_language_rules):
        ...
        for i in range(len(text_characteristics[0])):
            new_data_row = [str(text_characteristics[0][i]), str(text_characteristics[1][i]), str(text_characteristics[2][i]),
                            str(text_characteristics[3][i]), str(text_characteristics[4][i]), str(text_characteristics[5][i]),
                            str(text_characteristics[6][i]), str(easy_language_rules[0][i]), str(easy_language_rules[1][i]),
                            str(easy_language_rules[2][i]), str(easy_language_rules[3][i]), str(easy_language_rules[4][i]),
                            str(easy_language_rules[5][i]), str(easy_language_rules[6][i]), str(easy_language_rules[7][i]),
                            str(easy_language_rules[8][i]), str(easy_language_rules[9][i]), str(easy_language_rules[10][i]),
                            str(easy_language_rules[11][i]), str(easy_language_rules[12][i]), str(easy_language_rules[13][i]),
                            str(easy_language_rules[14][i]), str(easy_language_rules[15][i]), str(easy_language_rules[16][i]),
                            str(easy_language_rules[17][i])]
